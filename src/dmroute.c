...
dmod_dmroute_api_declaration(1.0, dmroute_t, _create, ( void ))
{
    ...
    struct dmroute *instance = Dmod_Malloc(sizeof(*instance));
    if (instance == NULL)
    {
        return NULL;
    }
...
dmod_dmroute_api_declaration(1.0, void, _destroy, ( dmroute_t handle ))
{
    Dmod_Free(handle);
}

dmod_dmroute_api_declaration(1.0, bool, _is_valid, ( dmroute_t handle ))
{
